...
<div class='container navbar navbar-default' role="navigation">
  <div class='navbar-header'>
      <?php echo html::a($this->createLink('zuser'), "用户管理", "class='navbar-brand' style='font-size:17px'")?>
      <?php echo html::a($this->createLink('zfostore'), "商城管理", "class='navbar-brand' style='font-size:17px'")?>
  </div>
