...
var AFreeAnimalAnim = (function(){
    var $Canvas, $KCanvas, $KCaWidth, $KCaHeight;
    ...
    var init = function(canvas,width,height){
        ...
        $KCanvas = new KCanvas();
        $KCanvas.ctx = $Canvas.getContext("2d");
    ...
    var addBackground = function(){
        ...
        var nCurrentFrame = 1,nMaxFrame = 11;
        oImg.src = "./assets/images/afreeanimal/scene/scene1-1.png";

        $Background.x = 0;
        $Background.y = 0;
        $Background.width = $KCaWidth;
        $Background.height = $KCaHeight;
        $Background.sx = 0;
        $Background.sy = 0;
        $Background.sw = 1000;
        $Background.sh = 600;
        ...
        setInterval(function(){
            oImg.src = "./assets/images/afreeanimal/scene/scene1-"+ nCurrentFrame +".png"
            $Background.img = oImg;
            nCurrentFrame++;
    ...
    var clearCanvas = function(){
        $KCanvas.ctx.clearRect(0,0,$KCaWidth,$KCaHeight)
    }
...
var manifest = [
    "./assets/images/afreeanimal/scene/scene1-1.png",
    "./assets/images/afreeanimal/scene/scene1-2.png",
    "./assets/images/afreeanimal/scene/scene1-3.png",
    "./assets/images/afreeanimal/scene/scene1-4.png",
    "./assets/images/afreeanimal/scene/scene1-5.png",
    "./assets/images/afreeanimal/scene/scene1-6.png",
    "./assets/images/afreeanimal/scene/scene1-7.png",
    "./assets/images/afreeanimal/scene/scene1-8.png",
    "./assets/images/afreeanimal/scene/scene1-9.png",
    "./assets/images/afreeanimal/scene/scene1-10.png",
    "./assets/images/afreeanimal/scene/scene1-11.png"
];
var manifest = manifest.map(function(src){
